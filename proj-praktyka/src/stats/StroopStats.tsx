...
return (
    <div className="mt-6 border-2 border-white/60 rounded-4xl py-4 bg-red-500/60 w-200">
        ...
        <div className="flex justify-center gap-2 mb-8">
            ...
            <button className="bg-white/5 border-2 border-white/10 text-white/50 hover:bg-white/10 flex ml-12 justify-center items-center rounded-4xl px-4 py-1 cursor-pointer" onClick={clearStroopHistory}>Wyczyść historię</button>
        </div>
