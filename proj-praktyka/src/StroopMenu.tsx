...
import Foto1 from "./assets/one_13927766.png";
import Foto2 from "./assets/2_13927999.png";
import Foto3 from "./assets/3_13928041.png";
import Foto4 from "./assets/four_13928087.png";
      ...
      <div className="redR rounded-[15px] p-8 m-0 leading-[40px] text-white">
        ...
        <div className="pb-8">
          ...
          <div className="flex gap-8 bg-[#310606a6] text-[12px] p-4 border rounded-[15px] border-[#4e0101] border-solid items-center justify-center">
            <p className="w-[100px] flex justify-center gap-1.5"><img className="h-6 w-6 relative top-2" src={Foto1} alt="czerwony"/>- Czerwony</p>
            <p className="w-[100px] flex justify-center gap-1.5"><img className="h-6 w-6 relative top-2" src={Foto2} alt="niebieski"/>- Niebieski</p>
            <p className="w-[100px] flex justify-center gap-1.5"><img className="h-6 w-6 relative top-2" src={Foto3} alt="zielony"/>- Zielony</p>
            <p className="w-[100px] flex justify-center gap-1.5"><img className="h-6 w-6 relative top-2" src={Foto4} alt="żółty"/>- Żółty</p>
          </div>
        </div>
        <div onClick={onStart}>
