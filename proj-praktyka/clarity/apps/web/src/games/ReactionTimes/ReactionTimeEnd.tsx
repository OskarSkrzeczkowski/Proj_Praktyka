...
export const ReactionEnd = ({onRestart, score, avgTime, misses, bTime}: ReactionEndProps) => {
    return(
      ...
      <div className= "rounded-[15px] p-8 m-0 leading-10 text-white blueR">
...
<div className="grid grid-cols-2 gap-2 justify-items-center w-full mb-6">
          <div className="bg-[#0B0352] border border-[#070236] rounded-2xl w-3xs flex flex-col justify-center items-center p-4 cursor-default">
