...
function Stats() {
    ...
    return (
        <div className="flex flex-col gap-8 min-h-screen w-full items-center pb-10">
            ...
            <div className="flex justify-between items-center w-full max-w-250 px-8 text-white mt-8">
            ...
            <div className="flex gap-4 w-full max-w-250 px-8 border-b-2 border-white/10 pb-4">
                <button 
