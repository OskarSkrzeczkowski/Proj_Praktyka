import { BackButton, TimeList } from '@clarity/ui'
...
interface MenuProps {
  ...
  level: NBackLevel;
  setLevel: (level: NBackLevel) => void;
  onStart: () => void;
  onBack: () => void;
}

export const NBackMenu = ({selectedDuration, setSelectedDuration, level, setLevel, onStart, onBack}: MenuProps) => {
    return (
    <div className="min-h-screen w-full flex items-center justify-center p-4">
        ...
        <div className="chLevel">
          <h4 className="text-[24px] pb-1.5 font-medium">Wybierz poziom</h4>
            <LevelList onLevelChange={setLevel} currentLevel={level} />
        </div>
